...
$configs = [
    ...
    // 禁止访问模块
    'deny_module_list'        => ['common','portal','install'],
    // 默认控制器名
    ...
    // | 文件服务器配置
    // +----------------------------------------------------------------------
    'file_server_url' =>'http://upload.ddxm661.com',
    // +----------------------------------------------------------------------
    // | 数据库设置
    // +----------------------------------------------------------------------
    'database'                => [
    ...
    'wechat'                  =>[
        ...
        'secret' => 'f775096b8d02d3a34761ccef9796c8f4',
    ...
    'ddxx'=>[
        ...
        'type'        => 'mysql',
        // 服务器地址
//        'hostname'    => '120.55.63.230',//正式服
//        'hostname'    => 'localhost',//正式服
        'hostname'    => 'localhost',//正式服
...
//        'password'    => 'yu12346',
    ...
    'qiniu'=>[
        ...
        'bucket' => 'ddxm-item',
        'domain'=>'http://picture.ddxm661.com'
    ],
    //快递鸟api
    'kdnapi'=>[
        'appid'     => '1448049',
        'appkey'    => 'ebeb5bc1-0dd6-4efc-806d-3f5812877735',
        'apiurl'    => 'http://api.kdniao.com/Ebusiness/EbusinessOrderHandle.aspx'
    ],
    //经营数据显示成本配置
    'finance' =>[
        'show_cost_finance'     => true
    ]
];
