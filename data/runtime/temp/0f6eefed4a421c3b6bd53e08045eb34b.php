<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"themes/admin_simpleboot3/admin\user\edit.html";i:1554867179;s:43:"themes/admin_simpleboot3/public\header.html";i:1554867210;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('User/editPost'); ?>">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<select class="form-control" name="user_type">
						<option <?php if($user_type == 1): ?> selected="selected" <?php endif; ?> value="1">管理员</option>
						<option <?php if($user_type == 2): ?> selected="selected" <?php endif; ?> value="2">用户</option>
					</select>
				</div>
			</div>
			<div class="form-group">
			...
			<!--<div class="form-group">-->
				<!--<label for="input-user_email" class="col-sm-2 control-label"><span class="form-required">*</span><?php echo lang('门店'); ?></label>-->
				<!--<div class="col-md-6 col-sm-10">-->
					<!--<select class="form-control" name="shop_id">-->
						<!--<option value="">请选择</option>-->
						<!--<?php foreach($shopInfo as $v): ?>-->
							<!--<option <?php if($shop_id == $v['id']): ?> selected="selected" <?php endif; ?> value="<?php echo $v['id']; ?>"><?php echo $v['name']; ?></option>-->
						<!--<?php endforeach; ?>-->
					<!--</select>-->
				<!--</div>-->
			<!--</div>-->
