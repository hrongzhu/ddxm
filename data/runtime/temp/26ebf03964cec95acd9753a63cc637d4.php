<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"themes/admin_simpleboot3/admin\index\index.html";i:1558665549;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <meta charset="utf-8">
    <title>捣蛋熊猫 <?php echo lang('ADMIN_CENTER'); ?></title>
...
<div class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="<?php echo url('admin/index/index'); ?>" class="navbar-brand" style="min-width: 200px;text-align: center;">捣蛋熊猫后台管理</a>
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <?php if(isset($admin['avatar']) && $admin['avatar']): ?>
                            ...
                            <?php else: ?>
                            <img class="nav-user-photo" width="30" height="30"
                                 src="__TMPL__/public/assets/images/logo-11.png" alt="<?php echo (isset($admin['user_login']) && ($admin['user_login'] !== '')?$admin['user_login']:''); ?>">
                        <?php endif; ?>
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
                        ...
                        <!--<?php endif; ?>-->
                        <?php if(cmf_auth_check(cmf_get_current_admin_id(),'admin/user/userinfo')): ?>
                            <li>
...
<div class="main-container container-fluid">
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-shortcuts" id="sidebar-shortcuts">
            ...
            <?php if($_SESSION['think']['ADMIN_ID'] == 1): ?>
