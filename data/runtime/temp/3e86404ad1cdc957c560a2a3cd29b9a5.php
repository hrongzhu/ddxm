<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_simpleboot3/admin\user\index.html";i:1554867179;s:43:"themes/admin_simpleboot3/public\header.html";i:1554867210;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap js-check-wrap">
        ...
        <form class="well form-inline margin-top-20" method="post" action="<?php echo url('User/index'); ?>">
            ...
            手机号:
            <input type="text" class="form-control" name="user_email" style="width: 120px;" value="<?php echo input('request.user_email/s',''); ?>" placeholder="请输入<?php echo lang('MOBILE'); ?>">
				...
				<tr>
					...
					<td>
						...
						<font color="#cccccc"><?php echo lang('EDIT'); ?></font>  <font color="#cccccc"><?php echo lang('DELETE'); ?></font>
							...
							<a href="<?php echo url('user/bindShop',array('id'=>$vo['id'])); ?>"><?php echo lang('绑定店铺'); ?></a>|
							<?php if($vo['user_status'] == 1): ?>
