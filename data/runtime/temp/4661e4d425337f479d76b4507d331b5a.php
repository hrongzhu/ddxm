<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"themes/admin_simpleboot3/admin\card\card_add.html";i:1557823159;s:45:"themes/admin_simpleboot3/public\ptheader.html";i:1554867210;s:45:"themes/admin_simpleboot3/public\ptfooter.html";i:1554867211;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
	<head>
    ...
    <div  class="panel-body">
        <div class="form-x">
            <div class="form-group">
                ...
                <label>
                    <input type="text" class="input" id="name" name="name" value="" data-validate="required:请填写内容">
                </label>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div id="fileList" class="uploader-list">
                        <div>
                            <img src="" id="headimg" style="height:80px;margin-bottom: 10px" alt="">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <input type="text" class="input" id="restrict_num" name="restrict_num" value="0" data-validate="required:请填写数字,znumber:请输入不含负数的数字">
            ...
            <div class="form-group">
                ...
                <div class="button-group border-blue radio">
                    <label class="button radius-rounded active">
                        <input type="radio" name="type" checked value="1" > 包月卡
                    </label>
                    <label class="button radius-rounded">
                        <input type="radio" name="type" value="2"> 次卡
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <input type="text" class="input" id="money" name="money" value="0" data-validate="required:请填写数字,zfloat:请输入不含负数的数字"/>
                </div>
            </div>
            <!-- 次卡显示内容 -->
                ...
                <div class="form-group">
                    ...
                    <table class="table table-hover table-bordered" id="select-service">
						...
						<tbody id="server-price-list">
							<tr>
                                <td>
                                    <select class="input" onchange="change_server(this)" >
                                ...
                                <td><input type="text" onchange="edit_money(this)" class="input" value="0" ></td>
            ...
            <div class="select-more">
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-10">
                        <input type="text" class="input" id="expire_month" name="expire_month" value=""  data-validate="required:请填写数字,plusinteger:请输入大于0的数字">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="button-group border-blue checkbox">
                        <?php if($serverList != ''): foreach($serverList as $v): ?>
                                <label class="button radius-rounded">
                                    <input name="service_id" value="<?php echo $v['id']; ?>" type="checkbox"><?php echo $v['sname']; ?>
                                </label>
                            <?php endforeach; endif; ?>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="button-group border-blue radio">
                    <label class="button radius-rounded">
                        <input type="radio" name="is_online" value="1" > 显示
                    </label>
                    <label class="button radius-rounded">
                        <input type="radio" name="is_online" value="0"> 不显示
                    </label>
                </div>
            </div>
            <br>
...
<script type="text/javascript">
    ...
    function edit_money(obj){
		let price = $(obj).val();
		if (price < 0) {
            layer.msg('金额不能小于1', {icon:0,time:2000});
			return false;
		}
		sumPrice();
	}
        ...
        $.post("<?php echo url('card/getShopListByServiceId'); ?>",{service_id},function(res){
            if(res.code === 200){
                ...
                $.each(res.data,function(i,v){
                    shop_checkbox += `<label class="button radius-rounded">
