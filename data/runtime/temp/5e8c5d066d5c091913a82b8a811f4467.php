<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"themes/admin_simpleboot3/admin\ticket\voucher_list.html";i:1554867203;s:43:"themes/admin_simpleboot3/public\header.html";i:1554867210;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active">
            <a href="<?php echo url('ticket/voucherList'); ?>">代金券列表</a>
        </li>
        <li>
            <a href="javascript:parent.openIframeLayer('<?php echo url('Ticket/ticketAddOrUpdate',['type'=>1]); ?>','新增代金券',{});">新增代金券</a>
        </li>
    </ul>
    ...
    <table class="table table-hover table-bordered">
        ...
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
            <tr style="height: 55px;">
                ...
                <td><?php echo (isset($v['integral_price']) && ($v['integral_price'] !== '')?$v['integral_price']:''); ?> 服务积分</td>
                ...
                <td><?php echo (isset($v['get_way']['name']) && ($v['get_way']['name'] !== '')?$v['get_way']['name']:'兑换'); ?></td>
