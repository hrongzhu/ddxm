<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"themes/admin_simpleboot3/admin\finance\sale_report.html";i:1554867194;s:43:"themes/admin_simpleboot3/public\header.html";i:1554867210;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <form class="well form-inline margin-top-0" method="get" action="<?php echo url('Finance/sale_report'); ?>" id="search_form">
        <input type="text" class="form-control" name="item_name" style="width: 120px;" <?php if(isset($item_name)): ?> value="<?php echo $item_name; ?>"<?php endif; ?>
        placeholder="商品名称">
        ...
        <select class="form-control" name="sale_way">
            ...
            <option value="1" <?php if(isset($sale_way)&&$sale_way==1): ?>selected<?php endif; ?>>库存发货</option>
            <option value="2" <?php if(isset($sale_way)&&$sale_way==2): ?>selected<?php endif; ?>>线上代发</option>
        </select>
    ...
    <table class="table table-hover table-bordered">
        ...
        <tbody>
        售出总计：<?php echo $num_all; ?>&emsp;&emsp;&emsp;退货总计：<?php echo $refund_num_all; if(is_array($datas) || $datas instanceof \think\Collection || $datas instanceof \think\Paginator): if( count($datas)==0 ) : echo "" ;else: foreach($datas as $key=>$v): ?>
            <tr style="height: 55px;">
                <td><?php echo $v['sku_id']; ?></td>
                ...
                <?php endif; if($v['is_online']==0): ?>
                    <td>门店</td>
                <?php endif; if($v['sale_way']==1): ?>
                    <td>库存</td>
                <?php endif; if($v['sale_way']==2): ?>
                    <td>代发</td>
                <?php endif; ?>
