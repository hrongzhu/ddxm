<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"themes/admin_simpleboot3/admin\item\item_add.html";i:1554867192;s:43:"themes/admin_simpleboot3/public\header.html";i:1554867210;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal margin-top-20" action="javascript:void(0)">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<label class="radio-inline">
						<input type="radio" name="is_control" value="1"> 是
					</label>
					<label class="radio-inline">
						<input type="radio" name="is_control" value="0"  checked="checked"> 否
					</label>
				</div>
			</div>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <input type="text" name="price" id="price"><span id="warning" class="hidden" style="color: red;margin-left: 20px">控价商品，请谨慎修改价格！</span>
                </div>
            </div>
            <div class="form-group offline">
                <label for="input-name" class="col-sm-2 control-label"><span class="form-required">*</span>采购单价</label>
                <div class="col-md-6 col-sm-10">
                    <input type="text" name="cg_price" id="cg_price">
                </div>
            </div>
            <div class="form-group offline">
			...
			<div class="form-group offline">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" name="code" id="stock_alert">
				</div>
			</div>
            <div class="form-group online">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button id="submit" class="btn btn-primary"><?php echo lang('ADD'); ?></button>
				</div>
			</div>
		</form>
	</div>
	...
	<script type="text/javascript">
		var uploadImgList = []   // 保存上传图片后台返的路径
		$(function () {
        ...
        $('#submit').click(function(){
            ...
            // if(item_type.indexOf('2')!=-1){
             //    if($('#md_price').val()==''||$('#cg_price').val()==''||$('#code').val()==''){
            ...
            $.post("<?php echo url('Item/item_addPost'); ?>",{
                ...
                'is_priceContorl':is_control,'pics':pics,'content':content,'id':'','stock_alert':stock_alert
            },function(res){
                if(res.code==1){
		...
		$(document).on('click', '.upload-img-list .remove-img' , function () {
            ...
            $.post("<?php echo url('Item/delelteImage'); ?>",{
                'key':uploadImgList[index-1]
            },function(res){
                if(res.code==1){
                    uploadImgList.splice(index - 1, 1)
                    $(that).parent().remove()
                }else {
