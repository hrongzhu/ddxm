<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"themes/admin_simpleboot3/admin\wechat\menu1.html";i:1554867176;s:43:"themes/admin_simpleboot3/public\header.html";i:1554867210;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <link href="__STATIC__/css/wechat-menu.css" rel="stylesheet">
                    ...
                    <div class="widget-body no-padding">
                        <div class="weixin-menu-setting clearfix">
                            <div class="mobile-menu-preview">
                                <div class="mobile-head-title">捣蛋熊猫</div>
                                    ...
                                    <div class="item-info">
                                        <form id="form-item" class="form-item" data-value="">
                                            ...
                                            <div style="margin-top: 20px;">
                                                ...
                                                <dl class="is-item">
                                                    <dt id="current-item-type">
                                                        <span class="is-sub-item">子</span>菜单内容：
                                                    </dt>
                                                    <dd>
                                                        <input id="type1" type="radio" name="type" value="click"><label for="type1" data-editing="1">
                                                        ...
                                                        <input id="type3" type="radio" name="type" value="scancode_push">
                                                        <label for="type3" data-editing="1">
                                                            <span class="lbl_content">扫码推</span>
                                                        </label>
                                                        <input id="type4" type="radio" name="type" value="scancode_waitmsg">
                                                        <label for="type4" data-editing="1">
                                                            <span class="lbl_content">扫码推提示框</span>
                                                        </label>
                                                        <input id="type5" type="radio" name="type" value="pic_sysphoto">
                                                        <label for="type5" data-editing="1">
                                                            <span class="lbl_content">拍照发图</span>
                                                        </label>
                                                        <input id="type6" type="radio" name="type" value="pic_photo_or_album">
                                                        <label for="type6" data-editing="1">
                                                            <span class="lbl_content">拍照相册发图</span>
                                                        </label>
                                                        <input id="type7" type="radio" name="type" value="pic_weixin">
                                                        <label for="type7" data-editing="1">
                                                            <span class="lbl_content">相册发图</span>
                                                        </label>
                                                        <input id="type8" type="radio" name="type" value="location_select">
                                                        <label for="type8" data-editing="1">
                                                            <span class="lbl_content">地理位置选择</span>
                                                        </label>
                                                    </dd>
                                                </dl>
                                                <div id="menu-content" class="is-item">
                                                    ...
                                                    <div class="clickbox is-click" style="display: none;">
                                                        ...
                                                        <span class="create-click">
                                                            <a href="<?php echo url('wechat.response/select'); ?>" id="select-resources">
                                                                <i class="weixin-icon big-add-gray"></i><strong>选择现有资源</strong>
                                                            </a>
                                                        </span>
                                                        <span class="create-click">
                                                            <a href="<?php echo url('wechat.response/add'); ?>" id="add-resources"><i class="weixin-icon big-add-gray"></i><strong>添加新资源</strong>
                                                            </a>
                                                        </span>
                                                    </div>
                                                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-1 text-left">
                                <a href="<?php echo url('wechat/showMenu',['refresh'=>1]); ?>" class="btn btn-sm btn-success">读取微信菜单</a>
                            </div>
                            <div class="col-xs-2 text-center text-danger">
                                <i class="fa fa-lightbulb-o"></i> <small>可直接拖动菜单排序</small>
                            </div>
                            <div class="col-xs-8 text-center">
                                <a href="javascript:;" id="menuSyn" class="btn btn-danger">保存并发布</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="https://cdn.bootcss.com/Sortable/1.8.0-rc1/Sortable.min.js"></script>
    <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        var init_menu = function (menu) {
            ...
            var menuUpdate = function () {
                $.post("<?php echo url('update'); ?>", {menu: getMenuList()}, function (data) {
                    if (data['code'] == 200) {
            ...
            $(document).on('click', "#menuSyn", function () {
                $.post("<?php echo url('sync'); ?>", {}, function (ret) {
                    var msg = ret.hasOwnProperty("msg") && ret.msg != "" ? ret.msg : "";
                    if (ret.code == 200) {
                        layer.msg('菜单同步更新成功，生效时间看微信官网说明，或者你重新关注微信号！',{icon:1});
                    } else {
