...
class WxPayApi
{
     ...
     *
     * 企业付款到零钱
     * partner_trade_no、amount、desc、openid、check_name、mch_appid、mchid、spbill_create_ip、nonce_str
     * @param  $data
     * @param int $timeOut
     * @throws WxPayException
     * @return 成功时返回，其他抛异常
     */
    public static function transferToCoin($xmldata, $timeOut = 6)
    {
        $url = "https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers";
        $response = self::postXmlCurl($xmldata, $url, true, $timeOut);
        return $response;
    }
